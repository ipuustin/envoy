...
public:
  ...
  /**
   * Create a particular PrivateKeyMethodProvider implementation. If the implementation is unable to
   * produce a PrivateKeyMethodProvider with the provided parameters, it should throw an
   * EnvoyException. The returned pointer should always be valid.
  ...
  /**
   * Returns the identifying name for a particular implementation of PrivateKeyMethodProvider
