...
#include "envoy/extensions/private_key_operations_providers/qat/v3/qat.pb.h"
#include "envoy/extensions/private_key_operations_providers/qat/v3/qat.pb.validate.h"
...
QatPrivateKeyMethodFactory::createPrivateKeyMethodProviderInstance(
  ...
  ProtobufTypes::MessagePtr proto_config = std::make_unique<
      envoy::extensions::private_key_operations_providers::qat::v3::QatPrivateKeyMethodConfig>();

  Config::Utility::translateOpaqueConfig(message.typed_config(), ProtobufWkt::Struct(),
                                         ProtobufMessage::getNullValidationVisitor(),
                                         *proto_config);
  const envoy::extensions::private_key_operations_providers::qat::v3::QatPrivateKeyMethodConfig
      conf = MessageUtil::downcastAndValidate<
          const envoy::extensions::private_key_operations_providers::qat::v3::
